...
export default function Projects() {
  ...
  useEffect(() => {
    fetchProjects();
  }, [activeTab, activeStatus, entries, currentPage, search]);


  // Assign project to QA
  // const handleAssignQA = async (projectId, fileData) => {
  //   try {
  //     const response = await fetch(
  //       `http://${import.meta.env.VITE_BACKEND_NETWORK_ID}/api/projects/${projectId}/transition`,
  //       {
  //         method: "POST",
  //         headers: {
  ...
  //           to: "assigned_to_qa",
  //           role: "Developer",
  //           comment: "Assigning project to QA",
  //           ...fileData, // fileName & fileLink
  //         }),
  //       }
  //     );
  //     const result = await response.json();
  //     if (response.ok) {
  //       alert(result.message || "Project assigned to QA successfully.");
  //       fetchProjects();
  //     } else {
  //       alert(result.message || "Failed to assign project to QA.");
  //     }
  //   } catch (error) {
  //     console.error("Error assigning project to QA:", error);
  //     alert("Server error while assigning project.");
  //   }
  // };


  // Transition project status
  // const transitionProject = async (projectId, to, comment = "", fileName = "", role, fileLink = "") => {
  //   try {
  //     const response = await fetch(
  //       `http://${import.meta.env.VITE_BACKEND_NETWORK_ID}/api/projects/${projectId}/transition`,
  //       {
  ...
  const filteredData = data; // already filtered by backend
